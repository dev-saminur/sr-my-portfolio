...
const Contact = () => {
  return (
    <>
      <div className=" pt-1 pb-2 lg:pb-[122px]  relative overflow-hidden">
        <Container>
          <div>
